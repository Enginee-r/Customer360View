...
import SubsidiarySwitcher from './components/SubsidiarySwitcher';
import SubsidiaryDashboard from './components/SubsidiaryDashboard';
import CustomerListItem from './components/CustomerListItem';

const queryClient = new QueryClient();

function GroupDashboard({ onSelectCustomer }: { onSelectCustomer: (customerId: string) => void }) {
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div
          ...
          className="bg-datacamp-bg-contrast dark:bg-datacamp-dark-bg-secondary rounded-lg p-6 border border-datacamp-bg-tertiary dark:border-datacamp-dark-bg-tertiary cursor-pointer transition-all hover:shadow-lg hover:scale-105 hover:border-datacamp-success"
        >
          <div className="flex items-center justify-between">
        ...
        <div
          ...
          className="bg-datacamp-bg-contrast dark:bg-datacamp-dark-bg-secondary rounded-lg p-6 border border-datacamp-bg-tertiary dark:border-datacamp-dark-bg-tertiary cursor-pointer transition-all hover:shadow-lg hover:scale-105 hover:border-datacamp-warning"
        >
          <div className="flex items-center justify-between">
        ...
        <div
          ...
          className="bg-datacamp-bg-contrast dark:bg-datacamp-dark-bg-secondary rounded-lg p-6 border border-datacamp-bg-tertiary dark:border-datacamp-dark-bg-tertiary cursor-pointer transition-all hover:shadow-lg hover:scale-105 hover:border-datacamp-red"
        >
          <div className="flex items-center justify-between">
      ...
      {(showTopRevenue || showAtRisk) && (
        <div id="top-customers-section" className="scroll-mt-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Top Revenue Customers */}
            {showTopRevenue && (
              <div ref={topRevenueRef} className="bg-datacamp-bg-contrast dark:bg-datacamp-dark-bg-secondary rounded-lg p-6 border border-datacamp-bg-tertiary dark:border-datacamp-dark-bg-tertiary">
            ...
            {/* At-Risk Customers */}
            {showAtRisk && (
              <div ref={atRiskRef} className="bg-datacamp-bg-contrast dark:bg-datacamp-dark-bg-secondary rounded-lg p-6 border border-datacamp-bg-tertiary dark:border-datacamp-dark-bg-tertiary">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-datacamp-text-primary dark:text-datacamp-dark-text-primary flex items-center gap-2">
                    <svg className="h-5 w-5 text-datacamp-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
      ...
      <div id="health-distribution" className="grid grid-cols-1 lg:grid-cols-3 gap-6 scroll-mt-6">
        {/* Health Distribution */}
      ...
      <div className="min-h-screen bg-datacamp-bg-main dark:bg-datacamp-dark-bg-main transition-colors">
        ...
        <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="relative z-0 pt-6">
            ...
            {!selectedCustomerId && selectedSubsidiary && (
              <SubsidiaryDashboard
            ...
            {!selectedCustomerId && !selectedSubsidiary && (
              <GroupDashboard onSelectCustomer={setSelectedCustomerId} />
            )}
          </div>
        </main>
